															...
															<span class="price">
                                                                 <c:url var="get_url"
                                                                    ...
                                                                    <form:form id="bookDetail" method="GET"
                                                                        ...
                                                                        <button type="submit" class="btn btn-link" style="cursor:pointer;">Xem ngay</button>
                                                                    </form:form>
                                    ...
                                    <c:forEach var="item" items="${ categories }">
                                        <li>
                                            ...
                                            <form:form id="bookCategory" method="GET"
                                                ...
                                                <button class="btn btn-link text-uppercase font-weight-bold" type="submit" style="cursor:pointer;">${ item.name }</button>
                                            </form:form>
                                        </li>
                                    </c:forEach>
                                </ul>
...
<script>
    document.getElementById("bookDetailLink").onclick = function() {
        document.getElementById("bookDetail").submit();
    };
