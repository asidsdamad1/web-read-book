...
<!-- Mirrored from htmldemo.net/pustok/pustok/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Apr 2022 17:13:41 GMT -->
<head>
    <meta charset="utf-8" />
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="<c:url value="asset/css/main.css"/>"/>
    <link rel="shortcut icon" type="image/x-icon" href="<c:url value="asset/image/favicon.ico"/>">
</head>
...
<div class="site-wrapper" id="top">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-3 ">
                        <a href="index.html" class="site-brand">
                            <img src="<c:url value="asset/css/logo.png"/>" alt="">
                        </a>
                    </div>
                    <div class="col-lg-3">
                                        ...
                                        <div class=" single-cart-block ">
                                            <div class="cart-product">
                                                <a href="product-details.html" class="image">
                                                    <img src="<c:url value="${pageContext.request.contextPath}/asset/image/products/cart-product-1.jpg"/>" alt="">
                                                </a>
                                                <div class="content">
                ...
                <div class="container">
                    <div class="home-content text-center text-sm-left position-relative">
                        <div class="hero-partial-image image-right">
                            <img src="/asset/image/bg-images/home-slider-2-ai.png" alt="">
                        </div>
                        <div class="row g-0">
                ...
                <div class="container">
                    <div class="home-content text-center text-sm-left position-relative">
                        <div class="hero-partial-image image-left">
                            <img src="/asset/image/bg-images/home-slider-1-ai.png" alt="">
                        </div>
            ...
            <div class="row space-db--30">
                <div class="col-lg-6 col-md-6 mb--30">
                    <a href="#" class="promo-image promo-overlay">
                        <img src="/asset/image/bg-images/promo-banner-with-text.jpg" alt="">
                    </a>
                </div>
                <div class="col-lg-6 col-md-6 mb--30">
                    <a href="#" class="promo-image promo-overlay">
                        <img src="/asset/image/bg-images/promo-banner-with-text-2.jpg" alt="">
                    </a>
                </div>
            </div>
        </div>
                        ...
                        <div class="product-slider multiple-row  slider-border-multiple-row  sb-slick-slider"
                                ...
                                <div class="product-card">
                                    ...
                                    <div class="product-card--body">
                                        <div class="card-image">
                                            ...
                                            <div class="hover-contents">
                                                <a href="product-details.html" class="hover-image">
                                                    <img src="/asset/image/products/product-7.jpg" alt="">
                                                </a>
                                                <div class="hover-btns">
                                                    <a href="cart.html" class="single-btn">
                                                        <i class="fas fa-shopping-basket"></i>
                            ...
                            <div class="single-slide">
                                <div class="product-card">
                                    ...
                                    <div class="product-card--body">
                                        <div class="card-image">
                                            <img src="/asset/image/products/product-8.jpg" alt="">
                                            <div class="hover-contents">
                                                <a href="product-details.html" class="hover-image">
                                                    <img src="/asset/image/products/product-9.jpg" alt="">
                                                </a>
                                                <div class="hover-btns">
                                                    <a href="cart.html" class="single-btn">
                                                        <i class="fas fa-shopping-basket"></i>
                                ...
                                <div class="product-card">
                                    ...
                                    <div class="product-card--body">
                                        <div class="card-image">
                                            ...
                                            <div class="hover-contents">
                                                <a href="product-details.html" class="hover-image">
                                                    <img src="/asset/image/products/product-11.jpg" alt="">
                                                </a>
                                                <div class="hover-btns">
                                                    <a href="cart.html" class="single-btn">
                                                        <i class="fas fa-shopping-basket"></i>
                            ...
                            <div class="single-slide">
                                <div class="product-card">
                                    ...
                                    <div class="product-card--body">
                                        <div class="card-image">
                                            <img src="/asset/image/products/product-12.jpg" alt="">
                                            <div class="hover-contents">
                                                <a href="product-details.html" class="hover-image">
                                                    <img src="/asset/image/products/product-11.jpg" alt="">
                                                </a>
            ...
            <div class="product-slider with-countdown  slider-border-single-row sb-slick-slider" data-slick-setting='{
                ...
                <div class="single-slide">
                    <div class="product-card">
                        ...
                        <div class="product-card--body">
                            <div class="card-image">
                                <img src="/asset/image/products/product-13.jpg" alt="">
                                <div class="hover-contents">
                                    <a href="product-details.html" class="hover-image">
                                        <img src="/asset/image/products/product-11.jpg" alt="">
                                    </a>
    ...
    <section class="section-margin bg-image section-padding-top section-padding"
             data-bg="/asset/image/bg-images/best-seller-bg.jpg">
        <div class="container">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-5 col-md-6">
                        <div class="author-image">
                            <img src="/asset/image/others/best-seller-author.jpg" alt="">
                        </div>
                    </div>
            ...
            <div class="row space-db--30">
                <div class="col-lg-8 mb--30">
                    <div class="promo-wrapper promo-type-one">
                        <a href="#" class="promo-image  promo-overlay bg-image"
                           data-bg="/asset/image/bg-images/promo-banner-mid.jpg">
                            <!-- <img src="/asset/image/bg-images/promo-banner-mid.jpg" alt=""> -->
                        </a>
                ...
                <div class="col-lg-4 mb--30">
                    <div class="promo-wrapper promo-type-two ">
                        <a href="#" class="promo-image promo-overlay bg-image"
                           data-bg="/asset/image/bg-images/promo-banner-small.jpg">
                            <!-- <img src="/asset/image/bg-images/promo-banner-small.jpg" alt=""> -->
                        </a>
                        <div class="promo-text">
                            <div class="promo-text-inner">
    ...
    <section class="section-margin">
        <div class="promo-wrapper promo-type-three">
            <a href="#" class="promo-image promo-overlay bg-image" data-bg="/asset/image/bg-images/promo-banner-full.jpg">
            </a>
        ...
        <div class="container">
            ...
            <div class="blog-slider sb-slick-slider" data-slick-setting='{
                ...
                <div class="single-slide">
                    <div class="blog-card">
                        <div class="image">
                            <img src="/asset/image/others/blog-grid-1.jpg" alt="">
                        </div>
                        <div class="content">
                ...
                <div class="single-slide">
                    <div class="blog-card">
                        <div class="image">
                            <img src="/asset/image/others/blog-grid-2.jpg" alt="">
                        </div>
                        <div class="content">
                            <div class="content-header">
                                <div class="date-badge">
                ...
                <div class="single-slide">
                    <div class="blog-card">
                        <div class="image">
                            <img src="/asset/image/others/blog-grid-3.jpg" alt="">
                        </div>
                        <div class="content">
                            <div class="content-header">
                                <div class="date-badge">
    ...
    <div class="footer-bottom">
        <div class="container">
            ...
            <a href="#" class="payment-block">
                <img src="<c:url value="${pageContext.request.contextPath}/asset/image/icon/payment.png"/>" alt="">
            </a>
...
<!-- Mirrored from htmldemo.net/pustok/pustok/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Apr 2022 17:13:42 GMT -->
</html>