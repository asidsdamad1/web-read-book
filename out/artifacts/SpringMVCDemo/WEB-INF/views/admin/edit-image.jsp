...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <c:url var="post_url" value="/quan-tri/them-hinh-anh-cua-sach"/>
        <form:form method="POST" action=" ${ post_url }" modelAttribute="imgUpload"
                   enctype="multipart/form-data">
            <div class="form-horizontal">

                <form:hidden path="bookId" name="bookId"/>
